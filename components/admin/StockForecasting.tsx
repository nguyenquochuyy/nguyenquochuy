...
const StockForecasting: React.FC<StockForecastingProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 animate-fade-in">
      ...
      <div className="bg-white rounded-xl w-full max-w-6xl shadow-lg flex flex-col overflow-hidden" style={{ maxHeight: '92vh' }}>
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto">
              {!product ? (
                ...
                <div className="p-5 space-y-[15px]">

                  {/* Product header */}
                  <div className="flex items-center gap-[15px]">
                    {product.productImage
                      ? <img src={product.productImage} alt={product.productName} className="w-16 h-16 rounded-xl object-cover border border-slate-200 shadow-md" />
